...
module Types
  class RecordEnumType < BaseEnum
    ...
    RECORD_TYPES = { hygiene: 0, temperature: 1, humidity: 2 }.freeze
    RECORD_TYPES.each_key do |key|
  ...
  class RecordStatusEnumType < BaseEnum
    ...
    RECORD_STATUS = { normal: 0, overflow: 1, resolved: 2 }.freeze
    RECORD_STATUS.each_key do |key|
